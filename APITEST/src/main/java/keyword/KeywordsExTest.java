...
public class KeywordsExTest {
    public static void main(String[] args) throws URISyntaxException, IOException {
        ...
        //输入url
        HttpPost httpPost = new HttpPost("https://eae266ec46b040f9afb1ae22bef2676e.apig.cn-north-4.huaweicloudapis.com/v1/infers/240dd325-dfaf-4950-81a1-992f3aae0164/api/KeywordsEx");
        //Body参数
        JSONObject json = new JSONObject();
        json.put("token", "showdoc");
        json.put("keywordsNumbe","6");
        json.put("sour", "吉林：境外输入奥密克戎BA.2造成本地传播\\n\" +\n" +
                "                \"\\n\" +\n" +
